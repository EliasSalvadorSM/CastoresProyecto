...
public class menuPrincipal extends javax.swing.JFrame {
    ...
    private int idRol;
    public void setDatos (String nombre, int idRol){
        this.nombre = nombre;
        this.idRol = idRol;
        ...
        if(idRol== 2){
            btnHistoricos.setEnabled(false);
        }
    }
    ...
    private void initComponents() {
        ...
        btnHistoricos = new javax.swing.JButton();
        ...
        btnHistoricos.setText("Historicos");
    ...
    private void btnEntradasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntradasActionPerformed
        ...
        inventario.setRol(idRol);
        inventario.setEntradas(this);
    ...
    private javax.swing.JButton btnHistoricos;
